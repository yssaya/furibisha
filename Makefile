...
TARGETS         := $(addprefix bin/, aobaf autousi server playshogi crc64 extract net-test gencode ocldevs)
...
bin/aobaf: src/usi-engine/aobaf
	cp $^ $@
...
src/usi-engine/aobaf: FORCE bin/gencode
